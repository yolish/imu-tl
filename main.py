...
if __name__ == "__main__":
    ...
    if args.mode == 'train':
        ...
        stats_msg = "Performance of {} on {}".format(args.pretrained_path, args.imu_dataset_file)
        ...
        for i in range(len(accuracy_per_label)):
                logging.info("Performance for class [{}] - accuracy {:.3f}".format(i, accuracy_per_label[i]/count_per_label[i]))
